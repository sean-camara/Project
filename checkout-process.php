...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($items as $dish_id => $item) {
        ...
        $price = floatval($item['price']); // Not used here but could be saved if you want
    ...
    if ($stmt_clear_cart) {
        ...
        // Optional: handle error but not critical
    }

    // If everything is successful, send back success with order_id
